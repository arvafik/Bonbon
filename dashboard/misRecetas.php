<?php require_once "vistas/vistasmisrecetas/parte_superior.php" ?>
...
<div class="contenido">
    ...
    <div class="container">
        <table id="tabla" class="table is-hoverable is-striped" style="width:100%">
            ...
            <tbody style="color: var(--font-color);">
                <?php
                foreach ($data as $dat) {
                ?>
                    <tr>
...
<?php require_once "vistas/vistasmisrecetas/parte_inferior.php" ?>